...
class AngelList(object):
    ...
    def getAuthorizeURL(self, client_id = None, ):
        ...
        if self.client_id is None:
            raise AngelListError("client_id is NULL. Please set this or pass it as a parameter first.")
    ...
    def getAccessToken(self, client_id = None, client_secret = None, code = None):
      ...
      if self.client_secret is None:
        raise AngelListError("client_secret is NULL. Please set this or pass it as a parameter first.")

      if code is None:
        raise AngelListError("code is NULL. Please pass the REQUEST['code'] angel.co/api/oauth/authorize responeded with as a parameter.")
      ...
      try:
        ...
        # params = urllib.urlencode({'client_id':self.client_id, 'client_secret':self.client_secret, 'code':code, 'grant_type':'authorization_code'})
        ...
        print 'access token failed to fetch'
        access_token = ''
